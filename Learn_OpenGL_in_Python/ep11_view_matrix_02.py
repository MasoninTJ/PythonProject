...
def glfw_test_github():
    ...
    translation = pyrr.matrix44.create_from_translation(pyrr.Vector3([400, 300, 0]))
    model_loc = glGetUniformLocation(shader, 'model')

    # view matrix
    # 与之前不同的是这里使用look_at(eye,target,up)函数
    # look_at是摄像机的运动，而非模型的运动，虽然内部实现的原理是一样的
